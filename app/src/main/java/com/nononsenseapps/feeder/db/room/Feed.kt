...
import com.nononsenseapps.feeder.db.COL_LOCAL_ALLOW_LIST
import com.nononsenseapps.feeder.db.COL_LOCAL_BLOCK_LIST
...
constructor(
    ...
    // Per-feed filtering: newline-separated glob patterns
    @ColumnInfo(name = COL_LOCAL_BLOCK_LIST) var localBlockList: String = "",
    @ColumnInfo(name = COL_LOCAL_ALLOW_LIST) var localAllowList: String = "",
) {
